...
return [
    ...
    'Select the view / web page to then identify the action that is performed on it. Setting access Yes / No will indicate if the profile has access to this resource'=>'Selecciona la vista / página web para luego identificando la acción que se realiza sobre ella. El establecer acceso Sí/No indicará si el perfil tiene acceso a este recurso',
    ...
    'Your account don\'t have priviledges for this action,
                    please do not repeat this requirement. All site traffic is being monitored' => 'Su cuenta, no tiene privilegios para realizar esta acción. No repita esta acción. Todo el tráfico esta siendo monitoreado.',
    'Your account don\'t have priviledges for this action, 
